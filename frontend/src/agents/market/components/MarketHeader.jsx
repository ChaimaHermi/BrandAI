    ...
    <div className="rounded-xl border border-[#e8e4ff] bg-white p-4 shadow-sm">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-xl border border-[#4f45c8] bg-[#5b50d6] px-3 py-2 text-xs font-semibold text-white shadow-sm transition hover:bg-[#4f45c8] disabled:cursor-not-allowed disabled:opacity-60"
        >
