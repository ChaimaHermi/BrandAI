...
export const WEBSITE_BUILDER_TIMEOUTS_MS = {
  ...
  description: 90000,
  generation: 320000,
  /** Révision LLM (chat + fin d'édition manuelle) — peut dépasser 3 min sur gros HTML. */
  revision: 300000,
  deploy: 240000,
  save: 30000,
};
...
/**
 * Édition manuelle : `current_html` = HTML complet après modification.
 * Rôle de l'agent : vérifier/corriger le markup ; ne pas annuler les changements de contenu.
 */
