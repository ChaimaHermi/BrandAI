...
const ICON_MAP = {
  ...
  market: HiOutlineMagnifyingGlass,
  brand: HiOutlinePaintBrush,
  content: HiOutlineDocumentText,
  website: HiOutlineGlobeAlt,
  optimizer: HiOutlineChartBarSquare,
};
...
export function AgentCard({ agent, status, isActive, onClick }) {
  ...
  const baseClass =
    "flex w-full items-center gap-2.5 rounded-[8px] border p-2.5 text-left transition-all duration-200";
  const statusClasses = {
