...
import { AgentTimeline } from "../pipeline/AgentTimeline";
import { ResultDisplay } from "../pipeline/ResultDisplay";
            ...
            <div className="flex gap-2 overflow-x-auto pb-1">
              {AGENTS.map((agent) => (
                <button
                  ...
                  className={`shrink-0 rounded-lg border px-3 py-2 text-xs font-medium transition-all ${activeAgent === agent.id ? "border-[#7C3AED] bg-[#F5F3FF] text-[#7C3AED]" : "border-[#E5E7EB] bg-white text-[#6B7280]"}`}
                >
                  {agent.name}
                </button>
              ))}
