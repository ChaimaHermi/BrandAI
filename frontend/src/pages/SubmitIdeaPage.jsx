...
import { apiCreateIdea, getErrorMessage } from "../shared/services/idea.service";
              ...
              <div>
                ...
                <div className="mt-1 flex items-center justify-between gap-2">
                  <p className="text-xs text-[#6B7280]">
                    Minimum 20 caractères · Soyez précis, l&apos;agent s&apos;en
                    chargera
                  </p>
                  <span
                    className={`text-xs tabular-nums ${descNearLimit ? "text-amber-600" : "text-[#6B7280]"}`}
                  >
